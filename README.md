...
> **Writing the tests with an AI agent?** Point it at [AGENTS.md](AGENTS.md) — the short list of what
> this package does differently from what an agent will assume, and it ships inside
> `vendor/modxkit/testbench/`, where the agent can read it without leaving the project.
